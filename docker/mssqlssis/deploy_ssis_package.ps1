# References: https://docs.microsoft.com/en-us/sql/integration-services/ssis-quickstart-deploy-powershell?view=sql-server-2017
...
Write-Host "From " $ProjectFile " project file ..."
